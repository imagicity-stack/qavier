  ...
  return (
    <div className="flex min-h-[100dvh] flex-col items-center justify-center gap-8 bg-luxe-noir px-6 text-center">
      ...
      <p className="max-w-md font-sans text-luxe-taupe">
        This page slipped between Qavier&apos;s two universes. Choose a door and we&apos;ll
        get you back.
      </p>
      <div className="flex flex-col gap-4 sm:flex-row">
        ...
        <Link
          href="/"
          className="inline-flex items-center justify-center gap-2 px-8 py-4 font-sans text-[0.72rem] uppercase tracking-luxe text-luxe-taupe hover:text-luxe-cream"
        >
          ← The Portal
        </Link>
      </div>
